    ...
    <AdminLayout>
        <div>
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
                <h1 class="text-2xl sm:text-3xl font-bold theme-text">Categories</h1>
            ...
            <div class="theme-surface rounded-lg border border-gray-700 overflow-hidden">
                ...
                <div v-else class="md:hidden">
                    ...
                    >
                        <h3 class="theme-text font-medium mb-2">{{ category.name }}</h3>
                        <p class="theme-text-secondary text-sm mb-3">{{ category.description || 'No description' }}</p>
                ...
                <!-- Desktop View -->
                <table v-if="!loading && categories.length > 0" class="hidden md:table w-full">
            ...
            <div v-if="showModal" class="fixed inset-0 bg-black/50 flex items-center justify-center z-50 p-4"
                ...
                <div class="theme-surface rounded-lg p-4 sm:p-6 w-full max-w-md border border-gray-700">
