        ...
        <div class="max-w-md w-full">
            <div class="theme-background rounded-lg shadow-lg p-8">
                <div class="text-center mb-8">
                    <h1 class="text-3xl font-bold theme-text mb-2">Bejelentkezés</h1>
                    <p class="theme-text opacity-70">Üdvözlünk vissza!</p>
                </div>
                ...
                <form @submit.prevent="submit">
                    ...
                    <div class="flex items-center justify-between mb-6">
                        <label class="flex items-center">
                            ...
                            <span class="ml-2 text-sm theme-text">Emlékezz rám</span>
                        </label>
                    </div>
                    ...
                    <div v-if="form.errors.email || form.errors.password || errorMessage"
                        ...
                        <p class="text-sm">{{ errorMessage || 'Hibás e-mail cím vagy jelszó.' }}</p>
                    </div>
                    ...
                    <button type="submit" :disabled="form.processing"
                        ...
                        <span v-if="!form.processing">Bejelentkezés</span>
    ...
    router.post('/login', {
        ...
        onError: (errors) => {
            ...
            if (errors.email || errors.password) {
                errorMessage.value = 'Hibás e-mail cím vagy jelszó.';
            }
        },
        onFinish: () => {
            form.processing = false;
