        ...
        <div class="max-w-md w-full">
            <div class="theme-background rounded-lg shadow-lg p-8">
                <div class="text-center mb-8">
                    <h1 class="text-3xl font-bold theme-text mb-2">Regisztráció</h1>
                    <p class="theme-text opacity-70">Hozd létre a fiókodat</p>
                </div>
                ...
                <form @submit.prevent="submit">
                    ...
                    <div v-if="Object.keys(form.errors).length > 0"
                        ...
                        <p class="text-sm font-semibold mb-1">Kérjük javítsd a következő hibákat:</p>
                    ...
                    <button type="submit" :disabled="form.processing"
                        ...
                        <span v-if="!form.processing">Regisztráció</span>
